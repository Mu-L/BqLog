...
namespace bq {
    ...
    {
        napi_value v;
        napi_create_uint32(env, x, &v);
        return v;
    }
    inline napi_value make_napi_u64(napi_env env, uint64_t x)
    {
        napi_value v;
        napi_create_bigint_uint64(env, x, &v);
        return v;
    }
...
#define BQ_NAPI_CALL(env, return_value, expr)                                                                                                                                         \
    do {                                                                                                                                                                              \
...
#define BQ_NAPI_CALL_VOID(env, expr)                                                                                                                                                  \
    do {                                                                                                                                                                              \
        napi_status _status = (expr);                                                                                                                                                 \
        if (_status != napi_ok) {                                                                                                                                                     \
            const napi_extended_error_info* _info = nullptr;                                                                                                                          \
